...
const BUSINESS_LINE_KEYWORDS = [
  ...
  { line: "Land Shipment", keywords: ["land transit", "road transit", "road freight", "truck waybill", "cmr consignment note", "international consignment note", "mode of conveyance by land", "reefer truck"] },
  { line: "Marine Cargo (Non-Reefer)", keywords: ["marine cargo", "bill of lading", "ocean bill of lading", "sea shipment", "dry container", "open top container", "dry cargo", "port of discharge", "container", "consignee"] },
