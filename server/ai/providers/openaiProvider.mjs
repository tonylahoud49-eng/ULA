...
- Resolve party roles accurately before extracting names:
  1. applicant: The instructing insurance or reinsurance company/broker requesting the survey (e.g. "M/s. NASCO Re", "M/s. Fidelity Assurance and Reinsurance Company SAL"). NEVER extract policy legal clauses, exclusion headers, or reinsurer liability terms (such as "the Reinsurer shall be liable...") as an applicant name.
  2. insured: The commercial trading entity / policyholder (e.g. "M/s. AJA Group", "M/s. EXTRA FOUR CO. S.A.R.L").
  3. shipper: The origin supplier / vendor / exporter (e.g. "M/s. Global Foods Solutions USA Inc.", "M/s. Extra Four Co. SARL").
  4. consignee: The destination buyer / receiver (e.g. "M/s. Fresh Frozen Foods (Gambia) Ltd", "M/s. Hanna's Bakery").
  Never map a nearby company name, carrier, or email sender to insured unless the evidence expressly identifies that role.
- For chronology and surveyor notes, extract the incident narrative in sequenced steps:
  1. Incident notification during voyage/transshipment (e.g., reefer malfunction, container perforation, water discovery).
  2. Formal appointment of ULA by the Insurer/Applicant.
  3. Surveyor attendance, inspections, cross-stuffing, chemical/testing observations (e.g. silver nitrate seawater test), and carrier correspondence (e.g. MSC / Maersk notice and reserve letters).
  4. Delivery condition, sound arrival or damage quantification, and claim closeout or withdrawal confirmation.
- Distinguish claim resolution typology:
  - no_claim_sound_delivery: When cargo arrived in sound condition without loss, cross-stuffed safely, or when the file is closed with no claim raised (concluded indemnity is 0).
  - partial_damage_repair: When physical damage or water contamination occurred to specific items requiring replacement, repair labor, and deductible application.
  - total_loss: When the consignment is completely destroyed or condemned.
...
- Compare Master transport documents (e.g., ocean carrier Bill of Lading, master AWB) with House transport documents (e.g. freight forwarder B/L, house AWB). Differentiate: (1) Assured / Policyholder; (2) House Shipper (supplier); (3) House Consignee (buyer); (4) Master Consignee (destination clearing forwarder). Explicitly flag any vessel name or voyage number discrepancies between Master and House documents (e.g., Master B/L naming CMA CGM NANSHA while House B/L names CMA CGM TOKYO) as a conflict requiring confirmation.
- For physical damage, breakage, or collapse claims (e.g. marble, tiles, fragile cargo, machinery, containers), frame technical causation with loss-adjusting nuance. Distinguish observed physical conditions (e.g. crate frame collapse, marble fracture, impact chipping) from operational hypotheses (e.g. compatible with loss of restraint, cargo movement during handling/transit, or packaging void-filling inadequacy). Do not output a flat negative one-liner if technical indicators are present.
- For policy deductibles, extract the full text expression (e.g. "10% of claim value, minimum EUR 750.00" or "5% of adjusted loss, min $1,000 max $10,000"). Never conflate a percentage and a minimum threshold into a single concatenated number.
- Check for discrepancies between numeric invoice totals and amounts written in words on commercial invoices. Flag any clerical or valuation discrepancy for professional reconciliation rather than prematurely asserting underinsurance.
